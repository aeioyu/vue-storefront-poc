import { useCartFactory, useCategoryFactory, useFacetFactory, useMakeOrderFactory, useProductFactory, useReviewFactory, useShippingFactory, useShippingProviderFactory, useBillingFactory, Logger, useUserFactory, useUserBillingFactory, useUserOrderFactory, useUserShippingFactory, useWishlistFactory, AgnosticOrderStatus, track } from '@vue-storefront/core';
import { AttributeType, cartActions } from '@vue-storefront/commercetools-api';
...
var useCart = useCartFactory(params);
...
var useCategory = useCategoryFactory(params$1);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    filters = Object.keys(inputFilters).reduce(function (prev, curr) { return (__spreadArray(__spreadArray([], prev), inputFilters[curr].map(function (value) { return ({ type: AttributeType.STRING, name: curr, value: value }); }))); }, []);
...
var index = useFacetFactory(factoryParams);
...
var useMakeOrder = useMakeOrderFactory(factoryParams$1);
...
var useProduct = useProductFactory({
...
var useReview = useReviewFactory(params$2);
...
var index$1 = useShippingFactory(params$3);
...
var index$2 = useShippingProviderFactory(params$4);
...
var index$3 = useBillingFactory(params$5);
    ...
    return __generator(this, function (_f) {
        switch (_f.label) {
            ...
            case 2:
                ...
                Logger.error('useUser.authenticate', err_1.message);
...
var index$4 = useUserFactory(params$6);
...
var index$5 = useUserBillingFactory(params$7);
...
var index$6 = useUserOrderFactory(params$8);
...
var index$7 = useUserShippingFactory(params$9);
...
var index$8 = useWishlistFactory(params$a);
...
var orderStatusMap = (_a = {},
    _a[OrderState.Open] = AgnosticOrderStatus.Open,
    _a[OrderState.Confirmed] = AgnosticOrderStatus.Confirmed,
    _a[OrderState.Complete] = AgnosticOrderStatus.Complete,
    _a[OrderState.Cancelled] = AgnosticOrderStatus.Cancelled,
    _a);
...
export { cartGetters, categoryGetters, facetGetters, orderGetters, productGetters, reviewGetters, index$3 as useBilling, useCart, useCategory, index as useFacet, useMakeOrder, useProduct, useReview, index$1 as useShipping, index$2 as useShippingProvider, index$4 as useUser, index$5 as useUserBilling, index$6 as useUserOrder, index$7 as useUserShipping, index$8 as useWishlist, userBillingGetters, userGetters, userShippingGetters, wishlistGetters };
